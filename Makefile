...
deploy-sepolia:
	@forge script script/DeployRaffle.s.sol:DeployRaffle --rpc-url $(SEPOLIA_RPC_URL) --account sepoliaTestAccount --legacy --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv